...
SWIFT_CLASS("_TtC14UpcomingMovies12BaseVCForAll")
@interface BaseVCForAll : UIViewController
...
SWIFT_CLASS("_TtC14UpcomingMovies8BottamVC")
@interface BottamVC : BaseVCForAll
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
- (void)viewDidLoad;
- (void)viewWillAppear:(BOOL)animated;
@end
...
SWIFT_CLASS("_TtC14UpcomingMovies13SceneDelegate")
